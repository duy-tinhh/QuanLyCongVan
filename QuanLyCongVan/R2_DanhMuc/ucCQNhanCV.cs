...
{
    public partial class ucCQNhanCV : DevExpress.XtraEditors.XtraForm
    {
        public ucCQNhanCV()
        {
            InitializeComponent();
        ...
        Class.csCQNhanCV CongVan = new Class.csCQNhanCV();
        void Refesh()
        {
            try
            {
                grcData.DataSource = CongVan.SELECT_CQNHANCV();
            }
            catch
            {
            }
        ...
        private void txtMa_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool TrangThai = CongVan.SELECT_CQNHANCV_ID(ID);
                if (TrangThai == true)
                {
                    bLuu.Enabled = false;
        ...
        private void btXoa_Click(object sender, EventArgs e)
        {
            try
            {
                if (ThamSoHeThong.Quyen("ucCQNhanCV", "sDelete") == false)
                    return;
        ...
        {
            if (ThamSoHeThong.Quyen("ucCQNhanCV", "sPrint") == false)
                return;
        ...
        {
            if (ThamSoHeThong.Quyen("ucCQNhanCV", "sExport") == false)
                return;
        ...
        private void bLuu_Click(object sender, EventArgs e)
        {
            try
            {
                if ((txtMa.Properties.ReadOnly == false) && (ThamSoHeThong.Quyen("ucCQNhanCV", "sAdd") == false))
                    return;
                if ((txtMa.Properties.ReadOnly == true) && (ThamSoHeThong.Quyen("ucCQNhanCV", "sEdit") == false))
                    return;
                if (txtMa.Text == "")
                {
                ...
                else
                {
                    ...
                    {
                        CongVan.INSERT_CQNHANCV(ID, Name, Description, Active);
                    }
                    else
                    {
                        CongVan.UPDATE_CQNHANCV(ID, Name, Description, Active);
