...
{
    public partial class ucLoaiVanban : DevExpress.XtraEditors.XtraForm
    {
        public ucLoaiVanban()
        {
            InitializeComponent();
        ...
        Class.csLoaiVanBan CongVan = new Class.csLoaiVanBan();
        void Refesh()
        {
            try
            {
                grcData.DataSource = CongVan.SELECT_LOAIVANBAN();
            }
            catch
            {
            }
        ...
        private void btXoa_Click(object sender, EventArgs e)
        {
            try
            {
                if (ThamSoHeThong.Quyen("ucLoaiVanban", "sDelete") == false)
                    return;
                if (DevExpress.XtraEditors.XtraMessageBox.Show("Bạn thật sự muốn xóa ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                {
                    ...
                    if (CongVan.CHECK_LOAIVANBAN(ID, "CONGVANDEN") == true)
                    {
                    ...
                    else if (CongVan.CHECK_LOAIVANBAN(ID, "CONGVANDI") == true)
                    {
                        DevExpress.XtraEditors.XtraMessageBox.Show("Thông tin đã sử dụng không thể xoá !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else if (CongVan.CHECK_LOAIVANBAN(ID, "CONGVANDEN_DA") == true)
                    {
                        DevExpress.XtraEditors.XtraMessageBox.Show("Thông tin đã sử dụng không thể xoá !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else if (CongVan.CHECK_LOAIVANBAN(ID, "CONGVANDI_DA") == true)
                    {
                        DevExpress.XtraEditors.XtraMessageBox.Show("Thông tin đã sử dụng không thể xoá !", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                        CongVan.DELETE_LOAIVANBAN(ID);
                        Refesh();
                    }
                }
            }
        ...
        {
            if (ThamSoHeThong.Quyen("ucLoaiVanban", "sPrint") == false)
                return;
        ...
        {
            if (ThamSoHeThong.Quyen("ucLoaiVanban", "sExport") == false)
                return;
        ...
        private void bLuu_Click(object sender, EventArgs e)
        {
            try
            {
                if ((txtMa.Properties.ReadOnly == false) && (ThamSoHeThong.Quyen("ucLoaiVanban", "sAdd") == false))
                    return;
                if ((txtMa.Properties.ReadOnly == true) && (ThamSoHeThong.Quyen("ucLoaiVanban", "sEdit") == false))
                    return;
                if (txtMa.Text == "")
                {
                ...
                else
                {
                    ...
                    {
                        CongVan.INSERT_LOAIVANBAN(ID, Name, Description, Active);
                    }
                    else
                    {
                        CongVan.UPDATE_LOAIVANBAN(ID, Name, Description, Active);
