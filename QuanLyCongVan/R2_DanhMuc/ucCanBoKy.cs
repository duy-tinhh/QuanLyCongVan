...
{
    public partial class ucCanBoKy : DevExpress.XtraEditors.XtraForm
    {
        public ucCanBoKy()
        {
            InitializeComponent();
        ...
        Class.csCanBoKy CongVan = new Class.csCanBoKy();
        void Refesh()
        {
            try
            {
                grcData.DataSource = CongVan.SELECT_CANBOKY();
            }
            catch
            {
            }
        ...
        private void btXoa_Click(object sender, EventArgs e)
        {
            try
            {
                if (ThamSoHeThong.Quyen("ucCanBoKy", "sDelete") == false)
                    return;
        ...
        {
            if (ThamSoHeThong.Quyen("ucCanBoKy", "sPrint") == false)
                return;
        ...
        {
            if (ThamSoHeThong.Quyen("ucCanBoKy", "sExport") == false)
                return;
        ...
        private void bLuu_Click(object sender, EventArgs e)
        {
            try
            {
                if ((txtMa.Properties.ReadOnly == false) && (ThamSoHeThong.Quyen("ucCanBoKy", "sAdd") == false))
                    return;
                if ((txtMa.Properties.ReadOnly == true) && (ThamSoHeThong.Quyen("ucCanBoKy", "sEdit") == false))
                    return;
                if (txtMa.Text == "")
                {
