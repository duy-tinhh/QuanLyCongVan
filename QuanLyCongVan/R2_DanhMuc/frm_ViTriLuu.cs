...
{
    public partial class frm_ViTriLuu : DevExpress.XtraEditors.XtraForm
    {
        public frm_ViTriLuu()
        {
            InitializeComponent();
        ...
        Class.csViTriLuu CongVan = new Class.csViTriLuu();
        void Refesh()
        {
            try
            {
                grcData.DataSource = CongVan.SELECT_VITRILUU();
            }
            catch
            {
            }
        ...
        private void txtMa_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool TrangThai = CongVan.SELECT_VITRILUU_ID(ID);
                if (TrangThai == true)
                {
                    bLuu.Enabled = false;
        ...
        private void btXoa_Click(object sender, EventArgs e)
        {
            try
            {
                if (ThamSoHeThong.Quyen("frm_ViTriLuu", "sDelete") == false)
                    return;
                if (DevExpress.XtraEditors.XtraMessageBox.Show("Bạn thật sự muốn xóa ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Information) == DialogResult.Yes)
                {
                    ...
                    bool TrangThaiDi = CongVan.CHECK_VITRILUU_DI(ID);
                    bool TrangThaiDen = CongVan.CHECK_VITRILUU_DEN(ID);
        ...
        {
            if (ThamSoHeThong.Quyen("frm_ViTriLuu", "sPrint") == false)
                return;
        ...
        {
            if (ThamSoHeThong.Quyen("frm_ViTriLuu", "sExport") == false)
                return;
        ...
        private void bLuu_Click(object sender, EventArgs e)
        {
            try
            {
                if ((txtMa.Properties.ReadOnly == false) && (ThamSoHeThong.Quyen("frm_ViTriLuu", "sAdd") == false))
                    return;
                if ((txtMa.Properties.ReadOnly == true) && (ThamSoHeThong.Quyen("frm_ViTriLuu", "sEdit") == false))
                    return;
                if (txtMa.Text == "")
                {
                ...
                else
                {
                    ...
                    {
                        CongVan.INSERT_VITRILUU(ID, Name, Description, Active);
                    }
                    else
                    {
                        CongVan.UPDATE_VITRILUU(ID, Name, Description, Active);
